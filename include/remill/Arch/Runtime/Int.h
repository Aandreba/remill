...
struct TypeSelector<kDesiredSize, T, Ts...>
    : public TypeSelectorImpl<kDesiredSize, sizeof(T) ^ kDesiredSize, T,
                              Ts...> {};

using int8_t = signed char;
using uint8_t = unsigned char;
using int16_t = TypeSelector<2, short, int, long, long long>::Type;
using uint16_t = TypeSelector<2, unsigned short, unsigned, unsigned long,
                              unsigned long long>::Type;
using int32_t = TypeSelector<4, int, long, long long>::Type;
using uint32_t =
    TypeSelector<4, unsigned, unsigned long, unsigned long long>::Type;
using int64_t = TypeSelector<8, int, long, long long>::Type;
using uint64_t =
    TypeSelector<8, unsigned, unsigned long, unsigned long long>::Type;
